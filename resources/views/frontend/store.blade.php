            ...
            <div class="cta-inner text-center rounded">
              ...
              <div class="text-center mx-auto p-4">
                ...
                <blockquote class="blockquote my-4 p-3 bg-light rounded shadow-sm" style="max-width: 80%; margin-left: auto; margin-right: auto;">
                    ...
                    <footer class="blockquote-footer mt-2">摘錄自 <cite title="鄒築園">鄒築園的心聲</cite></footer>
                </blockquote>
              ...
              <div class="text-center mx-auto p-4">
                ...
                <blockquote class="blockquote my-4 p-3 bg-light rounded shadow-sm" style="max-width: 80%; margin-left: auto; margin-right: auto;">
                    ...
                    <footer class="blockquote-footer mt-2">摘錄自 <cite title="野牡丹咖啡莊園">野牡丹咖啡莊園的心聲</cite></footer>
                </blockquote>
              ...
              <div class="text-center mx-auto p-4">
                ...
                <blockquote class="blockquote my-4 p-3 bg-light rounded shadow-sm" style="max-width: 80%; margin-left: auto; margin-right: auto;">
                    ...
                    <footer class="blockquote-footer mt-2">摘錄自 <cite title="柏香茗茶">柏香茗茶的心聲</cite></footer>
                </blockquote>
              ...
              <div class="text-center mx-auto p-4">
                <p>
                  優遊吧斯是結合鄒族文化與精緻農業的旅遊園區，其**瑪翡咖啡莊園**提供遊客親身體驗咖啡種植與鄒族風味結合的獨特體驗。
                </p>
                
                <blockquote class="blockquote my-4 p-3 bg-light rounded shadow-sm" style="max-width: 80%; margin-left: auto; margin-right: auto;">
                    <p class="mb-0">「每一顆瑪翡咖啡豆都承載著鄒族的故事。在這裡，咖啡不僅是飲品，更是我們與山林、與傳統連結的橋樑。」</p>
                    <footer class="blockquote-footer mt-2">摘錄自 <cite title="優遊吧斯">優遊吧斯的心聲</cite></footer>
                </blockquote>
              ...
              <div class="text-center mx-auto p-4">
                ...
                <blockquote class="blockquote my-4 p-3 bg-light rounded shadow-sm" style="max-width: 80%; margin-left: auto; margin-right: auto;">
                    ...
                    <footer class="blockquote-footer mt-2">摘錄自 <cite title="鄒讚咖啡">鄒讚咖啡的心聲</cite></footer>
                </blockquote>
            ...
            <div class="cta-inner text-center rounded">
              ...
              <div class="text-center mx-auto p-4">
                ...
                <blockquote class="blockquote my-4 p-3 bg-light rounded shadow-sm" style="max-width: 80%; margin-left: auto; margin-right: auto;">
                    ...
                    <footer class="blockquote-footer mt-2">摘錄自 <cite title="飲山郁咖啡">飲山郁咖啡的心聲</cite></footer>
                </blockquote>
              ...
              <div class="text-center mx-auto p-4">
                ...
                <blockquote class="blockquote my-4 p-3 bg-light rounded shadow-sm" style="max-width: 80%; margin-left: auto; margin-right: auto;">
                    ...
                    <footer class="blockquote-footer mt-2">摘錄自 <cite title="七彩琉璃咖啡莊園">七彩琉璃咖啡莊園的心聲</cite></footer>
                </blockquote>
            ...
            <div class="cta-inner text-center rounded">
              ...
              <div class="text-center mx-auto p-4">
                ...
                <blockquote class="blockquote my-4 p-3 bg-light rounded shadow-sm" style="max-width: 80%; margin-left: auto; margin-right: auto;">
                    ...
                    <footer class="blockquote-footer mt-2">摘錄自 <cite title="豆御香藝伎咖啡莊園">豆御香的心聲</cite></footer>
                </blockquote>
              ...
              <div class="text-center mx-auto p-4">
                ...
                <blockquote class="blockquote my-4 p-3 bg-light rounded shadow-sm" style="max-width: 80%; margin-left: auto; margin-right: auto;">
                    ...
                    <footer class="blockquote-footer mt-2">摘錄自 <cite title="TFU'YA 咖啡莊園">TFU'YA 咖啡莊園的心聲</cite></footer>
                </blockquote>
              ...
              <div class="text-center mx-auto p-4">
                ...
                <blockquote class="blockquote my-4 p-3 bg-light rounded shadow-sm" style="max-width: 80%; margin-left: auto; margin-right: auto;">
                    ...
                    <footer class="blockquote-footer mt-2">摘錄自 <cite title="飛鼠咖啡">飛鼠咖啡的心聲</cite></footer>
                </blockquote>
              ...
              <div class="text-center mx-auto p-4">
                ...
                <blockquote class="blockquote my-4 p-3 bg-light rounded shadow-sm" style="max-width: 80%; margin-left: auto; margin-right: auto;">
                    ...
                    <footer class="blockquote-footer mt-2">摘錄自 <cite title="雅慕伊咖啡莊園">雅慕伊咖啡莊園的心聲</cite></footer>
                </blockquote>
